...
ADD_BENCHMARK ("NW" H/InclinedFeature/line/H_incline_45r_line "OGS_FEM_LIS" 2
	H/InclinedFeature/line/H_incline_45r_line_node_1.csv
	H/InclinedFeature/line/H_incline_45r_line_ele_1.csv
	)

ADD_BENCHMARK ("NW" H/InclinedFeature/quad/H_incline_45r_quad "OGS_FEM_LIS" 2
	H/InclinedFeature/quad/H_incline_45r_quad_node_1.csv
	H/InclinedFeature/quad/H_incline_45r_quad_ele_1.csv
	)

ADD_BENCHMARK ("NW" H/strack/strack "OGS_FEM_LIS" 2
	H/strack/strack_node_1.csv
	H/strack/strack_ele_1.csv
	)

ADD_BENCHMARK ("NW" H/transfer_bc/CONST/2units2faults "OGS_FEM_LIS" 2
	H/transfer_bc/CONST/2units2faults_time_POINT18.csv)

ADD_BENCHMARK ("NW" H/transfer_bc/MAT/2units2faults "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NB" T/axi_T/line/T_1D_axi "OGS_FEM_LIS" 2
	T/axi_T/line/T_1D_axi_node_100.csv
	T/axi_T/line/T_1D_axi_time_POINT3.csv
	)

ADD_BENCHMARK ("NB" T/diffusion_T/line/TDiff "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NB" T/diffusion_q/line/TDiff-Wall "OGS_FEM_LIS" 2
	T/diffusion_q/line/TDiff-Wall_time_POINT3.csv
	T/diffusion_q/line/TDiff-Wall_time_POINT5.csv
	)

ADD_BENCHMARK ("NB" T/diffusion_T/tri/t_tri "OGS_FEM_LIS" 2
	T/diffusion_T/tri/t_tri_time_POINT0.csv
	T/diffusion_T/tri/t_tri_time_POINT4.csv
	T/diffusion_T/tri/t_tri_time_POINT5.csv
	)

ADD_BENCHMARK ("NW" T/diffusion_T/tet/t3d "OGS_FEM_LIS" 2
	T/diffusion_T/tet/t3d_time_POINT12.csv)

ADD_BENCHMARK ("NW" T/transfer_bc/1d/test "OGS_FEM_LIS" 2
	T/transfer_bc/1d/test_node_1.csv)

ADD_BENCHMARK ("NW" T/transfer_bc/2d/test "OGS_FEM_LIS" 2
	T/transfer_bc/2d/test_node_1.csv)

ADD_BENCHMARK ("NW" T/transfer_bc/3d/test "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NW" M/elastic_t/quad/rect "OGS_FEM_LIS" 2
	M/elastic_t/quad/rect_node_1.csv)

ADD_BENCHMARK ("NW" M/elastic_t/tri/rect "OGS_FEM_LIS" 2
	M/elastic_t/tri/rect_node_1.csv)

ADD_BENCHMARK ("NW" M/elastic_t/hex/cube "OGS_FEM_LIS" 2
	M/elastic_t/hex/cube_node_1.csv)

ADD_BENCHMARK ("NW" M/elastic_t/tet/cube "OGS_FEM_LIS" 2
	M/elastic_t/tet/cube_node_1.csv)

ADD_BENCHMARK ("NW" M/elastic_t_linear/hex/cube "OGS_FEM_LIS" 2
	M/elastic_t_linear/hex/cube_node_1.csv)

ADD_BENCHMARK ("NW" M/elastic_u/quad/rect "OGS_FEM_LIS" 2
	M/elastic_u/quad/rect_node_1.csv)

ADD_BENCHMARK ("NW" M/gravity/quad/rect "OGS_FEM_LIS" 2
	M/gravity/quad/rect_node_1.csv)

ADD_BENCHMARK ("NW" M/gravity/hex/cube "OGS_FEM_LIS" 2
	M/gravity/hex/cube_node_1.csv)

ADD_BENCHMARK ("NW" M/transient_ST/rect "OGS_FEM_LIS" 2
...
#ADD_BENCHMARK ("NW" TH/1d_thermal_expansion/exp1 "OGS_FEM_LIS" 2
#	TH/1d_thermal_expansion/exp1_time_POINT_LEFT.tec
#	TH/1d_thermal_expansion/exp1_time_POINT_RIGHT.tec)

ADD_BENCHMARK ("MCGB_EXCEEDING" TH/app/2units2faults/2units2faults "OGS_FEM_LIS" 2
...
#ADD_BENCHMARK ("MCGB_EXCEEDING" TH/2units2faults/FCT/2units2faults_FCT "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NW" HM/BMB2_2.7.1/quad/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.1/quad/hm_node_1.csv)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.2/quad/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.2/quad/hm_node_1.csv)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.3/hex/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.3/hex/hm_node_1.csv)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.4/hex/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.4/hex/hm_node_1.csv)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.5/quad/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.5/quad/hm_time_POINT1.csv
	HM/BMB2_2.7.5/quad/hm_time_POINT4.csv
	)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.7/strain_cpl/quad/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.7/strain_cpl/quad/hm_time_POINT1.csv
	HM/BMB2_2.7.7/strain_cpl/quad/hm_time_POINT4.csv
	)

ADD_BENCHMARK ("NW" HM/BMB2_2.7.7/stress_cpl/quad/hm "OGS_FEM_LIS" 2
	HM/BMB2_2.7.7/stress_cpl/quad/hm_time_POINT1.csv
	HM/BMB2_2.7.7/stress_cpl/quad/hm_time_POINT4.csv
	)

ADD_BENCHMARK ("NW" HM/RELOAD/fault_mech "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NW" TM/BMB2_2.8.1/quad/tm "OGS_FEM_LIS" 2
	TM/BMB2_2.8.1/quad/tm_node_1.csv)

ADD_BENCHMARK ("NW" TM/quad/tm2d "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NW" TM/axi/tri/TM_axi "OGS_FEM_LIS" 2
	TM/axi/tri/TM_axi_node_1.csv
	)

ADD_BENCHMARK ("NW" TM/tet/tm3d "OGS_FEM_LIS" 2
	TM/tet/tm3d_time_POINT12.csv)

ADD_BENCHMARK ("NW" TM/hex/tm3d "" 2
...
ADD_BENCHMARK ("NW" NUMERICS/FUNCTION/test "OGS_FEM_LIS" 2
...
ADD_BENCHMARK ("NW" NUMERICS/SUPG/steady/T_adv_diff_steady_SUPG_line "OGS_FEM_LIS" 2
	NUMERICS/SUPG/steady/T_adv_diff_steady_SUPG_line_node_1.csv)

ADD_BENCHMARK ("NW" NUMERICS/SUPG/transient/T_adv_diff_transient_SUPG_line "OGS_FEM_LIS" 2
